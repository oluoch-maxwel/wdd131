...
const temples = [
    ...
    },
    {
        ...
        location: "Mexico City, Mexico",
        dedicated: "1, November, 2026",
        area: 9300,
        imageUrl:
            "https://churchofjesuschristtemples.org/assets/img/temples/san-luis-potosi-mexico-temple/san-luis-potosi-mexico-temple-64803-main.jpg"
    },
];
...
function createTempleCard(filteredTemples) {
    const container = document.querySelector(".fig-section");
    container.innerHTML = ""; // Clears existing content before adding cards
